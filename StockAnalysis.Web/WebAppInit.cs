        ...
        public static WebApplicationBuilder CreateBuilder(string[] args)
        {
            ...
            builder.Services.AddSingleton<IModelIntegrationService>(provider =>
                new ModelIntegrationService(
                    builder.Configuration["PythonSettings:PythonPath"] ?? throw new InvalidOperationException("PythonPath is required"),
                    builder.Configuration["PythonSettings:ModelScriptPath"] ?? throw new InvalidOperationException("ModelScriptPath is required")
                ));
